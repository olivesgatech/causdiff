...
# models
from models import *
from models_bit_diff_causal import BitDiffPredictorTCN
from bit_diffusion_causal import GaussianBitDiffusion
from ema import *
...
class TrainerTCN:
    ...
    def train(self,
        ...
        for epoch in range(args.num_epochs + 1):
            ...
            print("training in the loop for " , len(dataloader), " number of loops")
    ...
    def validate(self,
        ...
        with torch.no_grad():
            ...
            for itr, sample_batched in enumerate(dataloader):
                ...
                ''' ACCURACIES '''
                # META INFO
                init_vid_len = sample_batched[-3]
                meta_dict = sample_batched[-2]
