...
class GaussianBitDiffusion(nn.Module):
    ...
    def p_losses(self,
        ...
        #loss_goal = F.cross_entropy(input=high_level_goal_softmax, target=gt_goal.squeeze(1))
    ...
    def model_predictions(self, x, pred_x_start_prev, t, obs, stage_masks, gt_goal=None):
        x_t = x
    ...
    def p_sample_ddim(
        ...
        preds = self.model_predictions(x=x,
                                       ...
                                       stage_masks=batch['mask_all'], gt_goal=batch['goal'])
